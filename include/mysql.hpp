...
class mysqlServer 
{
    ...
    public:
        ...
        void insert_readings(std::vector<MeterInfo> &meters, std::vector<std::chrono::steady_clock::time_point> &last_save_times); // insert readings into the Readings table in the database
};
